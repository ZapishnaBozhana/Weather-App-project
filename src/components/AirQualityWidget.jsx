  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:gap-2 text-left">
        <span className={`${currentAqi.color} font-semibold`}>
          {currentAqi.label}
        </span>
        <span className="text-[10px] text-slate-400 lowercase normal-case tracking-normal hidden sm:inline">
          |
        </span>
        <span className="text-slate-300 font-light lowercase normal-case tracking-normal">
          {currentAqi.desc}
        </span>
      </div>
    </button>
